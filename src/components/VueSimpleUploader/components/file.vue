    ...
    <div class="uploader-file" :status="status">
        ...
        <div class="uploader-file-info">
            ...
            <div class="uploader-file-status">
                <span v-show="status !== 'uploading'">{{uploader.extraStatus || statusText}}</span>
            ...
            <div class="uploader-file-actions" v-show="!uploader.extraStatus">
